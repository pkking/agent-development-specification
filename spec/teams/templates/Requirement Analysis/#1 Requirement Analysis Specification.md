...
| -------------------- | -------------------------------------------- | ----------------------- | ------------------ |
| **task1 _如：#123_** | **[TODO]** _(如：定义 Sidecar 流量转发规则)_ | 配置文件/代码           | **[TODO]** 5       |
| **task2 _如：#124_** | **[TODO]** _(如：配置 OBS 存储桶访问权限)_   | IAM Policy / Secret     | **[TODO]** 6       |
| **task2 _如：#125_** | **[TODO]** _(如：编写日志脱敏处理逻辑)_      | 核心逻辑代码            | **[TODO]** 7       |
